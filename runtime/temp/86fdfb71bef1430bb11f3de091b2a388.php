<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"E:\web\hesj84h8\wwwroot\weice\public/../application/admin\view\index\index.html";i:1565956706;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>：484519446</title>
...
<li>
    ...
    <ul class="submenu">
        <li>
            <a href="<?php echo url('index/tulist'); ?>">
...
<li>
    ...
    <ul class="submenu">
        <li>
            <a href="<?php echo url('index/volist'); ?>">
...
<li>
    ...
    <ul class="submenu">
        <li>
            <a href="<?php echo url('index/uslist'); ?>">
        ...
        <li>
            <a href="<?php echo url('index/frlist'); ?>">
                <span class="menu-text">
                    好友列表
                </span>
                <i class="menu-expand"></i>
        ...
        <li>
            <a href="<?php echo url('index/falist'); ?>">
                <span class="menu-text">
                    粉丝列表
                </span>
                <i class="menu-expand"></i>
