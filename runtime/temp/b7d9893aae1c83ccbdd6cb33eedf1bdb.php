<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"E:\web\hesj84h8\wwwroot\weice\public/../application/admin\view\index\falist.html";i:1565956708;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title></title>
...
<button type="button" tooltip="添加粉丝" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '../add/faadd'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center">粉丝名</th>
                                <th class="text-center">粉丝头像</th>
                                <th class="text-center">操作</th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php foreach($fa as $k => $v):?>
                            <tr>
                                <td align="center"><?php echo $v['idx_fan']?></td>
                                <td align="center"><?php echo $v['openid']?></td>
                                <td align="center"><?php echo $v['fan_id']?></td>
                                <td align="center"><?php echo $v['nickname']?></td>
                                <td align="center"><img src="<?php echo $v['headimgurl']?>" alt=""></td>
                                <td align="center">
                                    <a href="<?php echo url('/admin/edit/faedit/' . $v['idx_fan']);?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="<?php echo url('/admin/del/fadel/' . $v['idx_fan']);?>"  class="btn btn-danger btn-sm shiny">
