<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"E:\web\hesj84h8\wwwroot\weice\public/../application/admin\view\index\uslist.html";i:1565956708;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title></title>
    ...
    <link href="http://127.0.0.1/weice/public/static/admin/style/weather-icons.css" rel="sty lesheet">
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '../add/usadd'"> <i class="fa fa-plus"></i> Add
                </button>
                <div class="row">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><img src="<?php echo $v['headimgurl']?>" alt=""></td>
                                            <td align="center"><?php echo $v['user_profile']?></td>
                                            <td align="center"><?php echo $v['user_fans']?></td>
                                            <td align="center"><?php echo $v['user_pics']?></td>
                                            <!--<td align="center"><?php echo $v['status']?></td>-->
                                            <td align="center">
                                                <a href="<?php echo url('/admin/edit/usedit/' . $v['id']);?>" class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 编辑
                                                </a>
                                                <a href="<?php echo url('/admin/del/usdel/' . $v['id']);?>"  class="btn btn-danger btn-sm shiny">
