<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"C:\xampp\htdocs\weice\public/../application/admin\view\add\usadd.html";i:1560999190;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title></title>
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">增加用户</span>
                            </div>
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form enctype="multipart/form-data" class="form-horizontal" role="form" action="<?php echo url('admin/route/index'); ?>" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="open" class="col-sm-2 control-label no-padding-right">用户名</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="open" placeholder="" name="nickname" value="" required="" type="text">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="image" class="col-sm-2 control-label no-padding-right">上传头像</label>
                                            <div class="col-sm-6">
                                                <input  class="form-control" id="image" placeholder="" name="image[]" required="" type="file">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="describes" class="col-sm-2 control-label no-padding-right">关注度</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="describes" placeholder="" name="user_profile" value="" required="" type="text">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="tabname" class="col-sm-2 control-label no-padding-right">粉丝数</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="tabname" placeholder="" name="user_fans" value="" required="" type="text">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="tab" class="col-sm-2 control-label no-padding-right">相册数</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="tab" placeholder="" name="user_pics" value="" required="" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
