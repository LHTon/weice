<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"C:\xampp\htdocs\weice\public/../application/admin\view\add\faadd.html";i:1561134951;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title></title>
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">添加粉丝</span>
                            </div>
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('admin/route/faadd'); ?>" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="name1" class="col-sm-2 control-label no-padding-right">粉丝ID</label>
                                            <div class="col-sm-6">
                                                <select name="fan_id"  >
                                                    <option   value = "">--粉丝ID--</option>
                                                    <?php foreach($oid as $k => $v): ?>
                                                    <option value="<?php echo $v['id']?>"><?php echo $v['openid'] ?></option>
                                                    <?php endforeach;?>
                                                </select>
