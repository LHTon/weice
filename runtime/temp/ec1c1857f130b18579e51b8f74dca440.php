<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"C:\xampp\htdocs\weice\public/../application/admin\view\edit\usedit.html";i:1560952195;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title></title>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('admin/edit/usupdate'); ?>" method="post">
                        <div class="form-group">
                            <label for="name1" class="col-sm-2 control-label no-padding-right">用户名</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="name1" placeholder="" name="nickname" type="text" value="<?php echo $re['nickname']?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="name" class="col-sm-2 control-label no-padding-right">关注度</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="name" placeholder="" name="user_profile" type="text" value="<?php echo $re['user_profile']?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="con" class="col-sm-2 control-label no-padding-right">粉丝数</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="con" placeholder="" name="user_fans" type="text" value="<?php echo $re['user_fans']?>">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="condition" class="col-sm-2 control-label no-padding-right">相册数</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="condition" placeholder="" name="user_pics" type="text" value="<?php echo $re['user_pics']?>">
                            </div>
                        </div>
                        <input name="id" value="<?php echo $re['id'] ?>" type="hidden">
                        <div class="form-group">
