<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"C:\xampp\htdocs\weice\public/../application/admin\view\edit\fredit.html";i:1561122328;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title></title>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('admin/edit/frupdate'); ?>" method="post">
                       <?php foreach($rs as $k => $j):?>
                        <div class="form-group">

                            <label for="name1" class="col-sm-2 control-label no-padding-right">用户ID</label>

                            <div class="col-sm-6">
                                <select name="openid"  >
                                    <option   value = "0"><?php echo $j['openid'];?></option>
                                    <?php foreach($oid as $k => $v): ?>
                                    <option value="<?php echo $v['id']?>"><?php echo $v['openid']; ?></option>
                                    <?php endforeach;?>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            <label for="name" class="col-sm-2 control-label no-padding-right">好友ID</label>
                            <div class="col-sm-6">
                                <select name="fr_openid" >
                                    <option   value = "0"><?php echo $j['fr_openid'];?></option>
                                    <?php foreach($oid as $k => $v): ?>
                                    <option value="<?php echo $v['id']?>"><?php echo $v['openid'] ?></option>
                                    <?php endforeach;?>
                                </select>
                        ...
                        <div class="form-group">
                            <label for="con" class="col-sm-2 control-label no-padding-right">好友名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="con" placeholder="" name="nickname" type="text" value="<?php echo $j['nickname'];?>">
                            </div>
                        </div>

                        <input name="id" value="<?php echo $j['id']?>" type="hidden">
                        <div class="form-group">
