<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"C:\xampp\htdocs\weice\public/../application/admin\view\index\frlist.html";i:1561123787;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title></title>
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加好友" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '../add/fradd'"> <i class="fa fa-plus"></i> Add
                </button>
                <div class="row">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">好友id</th>
                                            <th class="text-center">好友名</th>
                                            <th class="text-center">好友头像</th>
                                            <th class="text-center">操作</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php foreach($fr as $k => $v): ?>
                                        <tr>
                                            <td align="center"><?php echo $v['id']?></td>
                                            <td align="center"><?php echo $v['openid']?></td>
                                            <td align="center"><?php echo $v['fr_openid']?></td>
                                            <td align="center"><?php echo $v['nickname']?></td>
                                            <td align="center"><img src="<?php echo $v['headimgurl']?>" alt=""></td>
                                            <td align="center">
                                                <a href="<?php echo url('/admin/edit/fredit/' . $v['id']);?>" class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 编辑
                                                </a>
                                                <a href="<?php echo url('/admin/del/frdel/' . $v['id']);?>"  class="btn btn-danger btn-sm shiny">
